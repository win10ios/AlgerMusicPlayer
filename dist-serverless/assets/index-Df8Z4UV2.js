    ...
    const openAlbum = async (item) => {
      try {
        ...
        const { getAlbumDetail } = await __vitePreload(async () => {
          const { getAlbumDetail: getAlbumDetail2 } = await import("./index-DEM82Ldr.js").then((n) => n.ec);
