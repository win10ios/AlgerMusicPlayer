function n(n2, a2, u2) {
  return (a2 = (function(n3) {
    var a3 = (function(n4, a4) {
      if ("object" != typeof n4 || !n4) return n4;
      var u3 = n4[Symbol.toPrimitive];
      if (void 0 !== u3) {
        var i2 = u3.call(n4, a4);
...
function o(n2, u2, i2, e2, r2) {
  ...
  if (n2 !== g2) for (var h2 = function() {
    ...
    if (a.some((function(n3) {
      ...
      h3 = true;
    } else -1 !== a.indexOf(g3) && r2[t2 + 1] && (i2.push(g3), h3 = true);
    if (h3) {
      var c = e2.length;
      o(t2 + 1, u2, i2, e2, r2), e2.length === c && (r2[t2 + 1] = false), i2.pop();
    }
  }, t2 = n2; g2 > t2; t2++) h2();
  else e2.push(i2.join(" "));
}
...
function h(a2, o2) {
  ...
  if (-1 !== r2) return [r2, r2 + o2.length - 1];
...
function t(n2, a2, u2) {
  for (var i2 = 0; n2.length > i2; i2++) for (var e2 = 0; a2.length > e2; e2++) {
    var o2 = a2[e2], g2 = o2.length, h2 = g2 === u2.length, t2 = true, l2 = 0, c = 0, f = 0;
    if (n2.length >= g2) {
      for (; o2.length > l2; l2++) if (0 === l2 && " " === n2[i2 + l2 + c]) c += 1, l2 -= 1;
      else if (" " === n2[i2 + l2 + f]) f += 1, l2 -= 1;
      else if (!r(n2[i2 + l2 + f], o2[l2], !n2[i2 + l2 + 1] || !o2[l2 + 1], h2)) {
        t2 = false;
        break;
      }
      if (t2) return [i2 + c, f + i2 + l2 - 1];
    }
  }
  return false;
}
var l = { match: (function(n2) {
  ...
  return Object.keys(n2).forEach((function(u2) {
    ...
    var a2 = {};
    for (var u2 in n3) for (var i3 = n3[u2], e3 = 0, o3 = i3.length; o3 > e3; e3++) a2[i3[e3]] = a2[i3[e3]] ? a2[i3[e3]] + " " + u2 : u2;
    return a2;
  })(i2), h;
