    ...
    const openAlbum = async (item) => {
      try {
        ...
        const { getAlbumDetail } = await __vitePreload(async () => {
          const { getAlbumDetail: getAlbumDetail2 } = await import("./index-0n6GrGnT.js").then((n) => n.ec);
